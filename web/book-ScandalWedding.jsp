...
<div id="templatemo_container">
    ...
    <div id="samplesToc">
        ...
        <div id="templatemo_content_right">
            ...
            <h1>The Scandal Behind the Wedding <span>(by Frances Bella)</span></h1>
             <div class="image_panel"><img src="images/templatemo_image_05.jpg" alt="CSS Template" width="100" height="170" /></div>

            
            <ul>
                <li><font size="2">Category: Politics</font></li>
            	<li><font size="2">January 2015</font></li>
                <li><font size="2">Price: 65</font></li>
                <li><font size="2">ISBN: 9780263257243</font></li>
                <li> <p>
...
Danny might be Dubai's latest darling, but even he can't afford to be papped leaving a hotel room with a thoroughly seduced-looking Georgia?not with the business deal of his life about to close! 
A quickie temporary marriage should let them both off the hook?except there's nothing quick about Danny's plans for celebrating their wedding night!
            </p>
             <div class="cleaner_with_height">&nbsp;</div>
             <h1><font size="3">A suggestion of related books:</font></h1>
            <div class="image_panel2">
                <a href="book-TheGoodDog.jsp"><img src="images/templatemo_image_08.jpg" alt="The Scandal Behind the Wedding" width="100" height="120" /></a>
                           </div>
             <div class="image_panel2">
