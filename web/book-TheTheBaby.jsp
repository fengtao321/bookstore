    ...
    <div id="samplesToc">
        ...
        <div id="templatemo_content_right">
            ...
            <h2>&nbsp;</h2>
             ...
             <h1>The Heiress's Secret Baby <span>(by Pembroke Sophie)</span></h1>
             <div class="image_panel"><img src="images/templatemo_image_06.jpg" alt="CSS Template" width="100" height="170" /></div>
            ...
            <ul>
                ...
                <li><font size="2">ISBN:  9780263257410</font></li>
                <li> <p>
            ...
            <p style="background-color: #0f0403">
                My Secret Bucket List Swim in the sea, naked in azure warm seas, not in the North sea Sleep out under the stars Have sex on the beach, the real deal, not the cocktail Drink an authentic margarita Fall in love in Paris Polly read the list through for the last time, feeling the carefree joie de vivre fall away and the old, familiar cloaks of respectability and responsibility settling back onto her shoulders. 
                They were a little heavy, but maybe that was to be expected after three months away. Three months, five wishes. And she'd achieved four out of the five, which wasn't bad going. 
                The heaviness lifted for a second as the highlights of the last three months flashed through her mind and then it descended again. What had she been thinking? She might as well have written the list in a silver pen and decorated it with pink love hearts and butterflies, pinning it on her wall next to a lipstick-kiss-covered poster of a pre-pubescent boy band. Polly pulled the page out of her diary and, without allowing herself a second's pause to reconsider, tore it into pieces. 
                It was time to reposition her three-month sabbatical into something more appropriate for the new CEO of a company with a multimillion-pound turnover. 
            </p>
            ...
            <div class="image_panel2">
             ...
             <div class="image_panel2">
             <a href="book-TheGoodDog.jsp"><img src="images/templatemo_image_08.jpg" alt="CSS Template" width="100" height="120" /></a>
             </div>
             <div class="image_panel2">
        <a href="book-BestFriend.jsp"><img src="images/templatemo_image_07.jpg" alt="CSS Template" width="100" height="120" /></a></div>
            ...
            <div class="image_panel2">
                <a href="book-TheGoodDog.jsp">The Good Dog</a>
                </div>  
             <div class="image_panel2">
                <a href="book-BestFriend.jsp">Best Friend to Wife </a><p></p><a href="book-BestFriend.jsp">and Mother? </a>
                </div> 
