    ...
    <div id="samplesToc">
        ...
        <div id="templatemo_content_right">
            ...
            <h2>&nbsp;</h2>
              ...
              <h1>Dating the Enemy <span>(by Page Amber)</span></h1>
            ...
            <ul>
                ...
                <li><font size="2">ISBN: 9780263257250</font></li>
                <li> <p>
            ...
            <p></p>
            <p></p>
            <p style="background-color: #0f0403">One Valentine's evening a group of single, dateless friends get together to play Trivial Pursuit. Brett (Guy Pearce), a friend of the host from Melbourne, has just landed a job as presenter of a TV gossip show. He is brash and self-confident. Tash (Claudia Karvan) is a science journalist for a national newspaper, studious, intense and self-conscious. 
                They have nothing in common, so naturally they get it together.A year later and Brett's career is going well, there is the possibility of a job in New York and popularity has gone to his head. Tash is still trying to write serious scientific articles for a paper more interested in gossip and sex and struggling to prevent her articles being buried on page 12. Their relationship is on the rocks. That night during a Valentine's boat trip on Sydney Harbour, an argument ensues and Brett decides he has had enough. Tash tells him: 'I wish you could be me, so you could see how I feel for once. 
        ...
        <a href="book-TamingTycoon.jsp"><img src="images/templatemo_image_04.jpg" alt="CSS Template" width="100" height="120" /></a></div>
            ...
            <div class="image_panel2">
                <a href="book-ConvenientBride.jsp">His Very Convenient Bride </a>
                </div>  
             <div class="image_panel2">
