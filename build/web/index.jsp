    ...
    <div id="samplesToc">
        ...
        <div id="templatemo_content_right">
        	...
        	<div class="templatemo_product_box">
            	...
            	<h1><a href="book-MightierSword.jsp ">Mightier Than the Sword  <span>(by Archer Jeffrey)</span></a></h1>
   	      <a href="book-MightierSword.jsp "><img src="images/templatemo_image_01.jpg" height="150" width="100" alt="image" /></a>
                <div class="product_info">
                  ...
                  <div class="buy_now_button" >
                      <form action="MyServlet" method="post">
                       <a href="#">
                          <input onmouseover="this.style.background='#0f0403';" onmouseout="this.style.background='transparent';" type="submit" name="Mightier Than the Sword"  style="font-size:11px; font-weight: bold;background-color:transparent;border-color: transparent;color:#ffffff;height: 30px; width: 100px; " value="Buy Now"/>
                      </a>
                      </form>
                  </div>
                    
                    <div class="detail_button"><a href="book-MightierSword.jsp ">Detail</a></div>
                </div>
            ...
            <div class="templatemo_product_box">
            	<h1><a href="book-ConvenientBride.jsp">His Very Convenient Bride  <span>(by Pembroke Sophie)</span></a></h1>
       	    <a href="book-ConvenientBride.jsp"><img src="images/templatemo_image_02.jpg" height="150" width="100" alt="image" /></a>
                <div class="product_info">
                	<p>&nbsp;</p>
                    <h3>$35</h3>
                     <div class="buy_now_button" >
                      <form action="MyServlet" method="post">
                      <a href="#">
                         <input onmouseover="this.style.background='#0f0403';" onmouseout="this.style.background='transparent';" type="submit" name="His Very Convenient Bride" style="font-size:11px; font-weight: bold;background-color:transparent;border-color: transparent;color:#ffffff; height: 30px; width: 100px;" value="Buy Now"/>
                          
                      </a>
                      </form>
                    
                  </div>
                    <div class="detail_button"><a href="book-ConvenientBride.jsp">Detail</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
            ...
            <div class="templatemo_product_box">
            	<h1><a href="book-DatingEnemy.jsp">Dating the Enemy <span>(by Page Amber)</span></a></h1>
   	      <a href="book-DatingEnemy.jsp"><img src="images/templatemo_image_03.jpg" height="150" width="100" alt="image" /></a>
                <div class="product_info">
                	<p>&nbsp;</p>
                    <h3>$65</h3>
                     <div class="buy_now_button"  >
                      ...
                      <a href="#">
                          ...
                          <input onmouseover="this.style.background='#0f0403';" onmouseout="this.style.background='transparent';" type="submit" name="Dating the Enemy"   style="font-size:11px; font-weight: bold;background-color:transparent;border-color: transparent;color:#ffffff;height: 30px; width: 100px; " value="Buy Now" />
                          
                      </a>
                      </form>
                  </div>
                    <div class="detail_button"><a href="book-DatingEnemy.jsp">Detail</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
            ...
            <div class="templatemo_product_box">
            	<h1><a href="book-TamingTycoon.jsp">Taming the French Tycoon<span>(by Winters Rebecca)</span></a></h1>
            	<a href="book-TamingTycoon.jsp"><img src="images/templatemo_image_04.jpg" height="150" width="100" alt="image" /></a>
                <div class="product_info">
                	<p>&nbsp;</p>
                    <h3>$45</h3>
                    <div >
                      ...
                      <a href="#">
                          ...
                          <input onmouseover="this.style.background='#0f0403';" onmouseout="this.style.background='transparent';" type="submit" name="Taming the French Tycoon"  style="font-size:11px; font-weight: bold;background-color:transparent;border-color: transparent;color:#ffffff; height: 30px; width: 100px;" value="Buy Now"/>
                          
                      </a>
                      </form>
                  </div>
                    </div>
                    <div class="detail_button"><a href="book-TamingTycoon.jsp">Detail</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
...
<div class="cleaner_with_height">&nbsp;</div>
<div class="cleaner_with_height">&nbsp;</div>
<h2 style="text-align: center; font-size: 12px">Page&nbsp;&nbsp; <strong><u> 1 </u><strong> <a href="#">&nbsp;&nbsp;2&nbsp;&nbsp;</a> <a href="#">3</a>&nbsp; ... &nbsp;<a href="#">6</a> </h2>

            <a href="index.jsp"><img src="images/templatemo_ads.jpg" alt="ads" height="130" width="670"/></a>
